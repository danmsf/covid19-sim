...
המאמר של () ומציג  את השוואת מקדמי ההדבקה בפרובינציות של סין בין בין תחילת
...
אלישר חודרוב, רועי עסיס, עוז מזרחי וצוותו ואניה סורקין)</span></p>
